...
def run_MD1(THERM,syst,el,ao,E,C,data,params):
    ##
    # Finds the keywords and their patterns and extracts the parameters
    # \param[in,out] THERM Thermostat object which couples molecular dynamics
    ...
    for i in xrange(Nsnaps):
        ...
        for j in xrange(Nsteps):
            ...
            # velocity scaling
            mol.p[0] = mol.p[0] * THERM.vel_scale(0.5*dt_nucl)
